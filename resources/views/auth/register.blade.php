    ...
    <main class="w-full max-w-lg fade-in-up">
        ...
        <div class="glass-card rounded-xl p-5 sm:p-6 w-full transition-all duration-200">
            ...
            <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-3.5" id="register-form">
                ...
                <!-- Submit Button -->
                <button class="w-full mt-1.5 bg-primary-container hover:bg-primary-container/90 active:scale-[0.99] text-white font-semibold text-xs sm:text-sm py-2.5 px-4 rounded-full shadow-sm hover:shadow transition-all flex justify-center items-center gap-1.5 group"
