...
<head>
    <meta charset="utf-8">
    <title>Seguimiento de tu pedido - PayMe Panamá</title>
    <style>
        ...
        <table class="main">
            ...
            <tr>
                <td class="content">
                    ...
                    <p>Hola <strong>{{ $pedido->usuario->nombre }}</strong>, han pasado algunos días desde que enviamos tu pedido <strong>{{ $pedido->numero_pedido }}</strong>.</p>
                    <p>Si ya lo recibiste, por favor ayúdanos a confirmar la entrega desde tu panel:</p>
                    <a href="{{ route('cliente.perfil.pedidos.detalle', $pedido->id) }}" class="button">Confirmar Recepción</a>
                </td>
            </tr>
            <tr>
                <td class="footer">
