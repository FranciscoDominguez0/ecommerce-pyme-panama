...
<div
    ...
    <div class="relative h-48 bg-white dark:bg-[#181a1b] p-4 flex items-center justify-center">
        ...
        @elseif($img && !empty($img->ruta))
            <span
                class="material-symbols-outlined text-[64px] text-slate-600 dark:text-slate-400 group-hover:scale-105 transition-transform duration-300">{{ $img->ruta }}</span>
        @else
