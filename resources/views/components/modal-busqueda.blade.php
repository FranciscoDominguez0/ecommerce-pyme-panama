...
<div id="{{ $id }}" 
    ...
    <div class="bg-white dark:bg-[#181a1b] rounded-2xl shadow-2xl border border-slate-100 dark:border-gray-700/80 w-full max-w-lg max-h-[85vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-150 relative z-10">
        
        <!-- Modal Header -->
        <div class="px-4 py-3 border-b border-slate-100 dark:border-gray-700/80 flex items-center justify-between bg-slate-50/70 dark:bg-transparent shrink-0">
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    <h3 class="text-xs font-bold text-slate-900 dark:text-white" id="{{ $id }}-titulo-text">{{ $titulo }}</h3>
                    <p class="text-[10px] text-slate-500">{{ $subtitulo }}</p>
                </div>
            </div>
            <button type="button" 
                    onclick="window.ModalBuscador.cerrar('{{ $id }}')" 
                    class="text-slate-400 hover:text-slate-600 dark:text-slate-400 p-1 rounded-lg hover:bg-slate-100 dark:bg-transparent transition-colors cursor-pointer">
                <span class="material-symbols-outlined text-[18px]">close</span>
            </button>
        </div>

        <!-- Buscador y Acciones Superiores -->
        <div class="p-3 border-b border-slate-100 dark:border-gray-700/80 bg-white dark:bg-[#181a1b] shrink-0 space-y-2">
            <div class="relative flex items-center">
                ...
                <input type="text" 
                       ...
                       class="w-full pl-9 pr-3 py-1.5 text-xs bg-slate-50 dark:bg-[#121415] border border-slate-200 dark:border-gray-700/80 rounded-xl focus:bg-white dark:focus:bg-[#1a1c1d] focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 text-slate-800 dark:text-gray-100 font-medium">
            </div>
        ...
        <div class="px-4 py-2.5 border-t border-slate-100 dark:border-gray-700/80 bg-slate-50/70 dark:bg-transparent flex items-center justify-between shrink-0 flex-wrap gap-2">
            ...
            <div class="flex items-center gap-2">
                ...
                <button type="button" 
                        onclick="window.ModalBuscador.cerrar('{{ $id }}')" 
                        class="px-3 py-1 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:bg-gray-700 rounded-xl transition-colors cursor-pointer">
                    Cerrar
                </button>
            </div>
        </div>
