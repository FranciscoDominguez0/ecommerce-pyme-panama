    ...
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold text-primary">Mis Pedidos</h1>
                    <p class="text-sm text-on-surface-variant mt-1">Revisa y rastrea tus compras recientes.</p>
                </div>
                <!-- Quick Filters -->
