        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
                <div>
                    ...
                    <p class="text-sm text-on-surface-variant mt-1">Administra las direcciones donde recibes tus pedidos.</p>
                </div>
            ...
            @if($direcciones->count() > 0)
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-8" id="lista-direcciones">
                    @foreach($direcciones as $dir)
                        ...
                        @endphp
                        <div class="bg-white border border-outline-variant rounded-xl p-6 flex flex-col gap-4 ambient-shadow ambient-shadow-hover transition-all duration-300 relative group">
            ...
            @else
                <div id="estado-vacio" class="text-center py-16 bg-white rounded-xl border border-outline-variant ambient-shadow mb-8">
...
<script>
    ...
    window.editarDireccion = function(id) {
        const card = document.querySelector('[onclick="editarDireccion(' + id + ')"]').closest('.bg-white');
