    ...
    <form action="{{ route('cliente.checkout.guardar-direccion') }}" method="POST" class="max-w-4xl mx-auto space-y-8">
        ...
        <div id="form_nueva_direccion" class="{{ $direcciones->count() > 0 ? 'hidden' : 'block' }} bg-surface-container-lowest border border-outline-variant rounded-xl p-6 shadow-sm mb-8">
            ...
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                <div>
                    <label for="alias" class="block text-xs font-semibold text-on-surface-variant mb-1">Alias (Ej: Casa, Trabajo)</label>
                ...
                <div>
                    <label for="nombre_receptor" class="block text-xs font-semibold text-on-surface-variant mb-1">Nombre de quien recibe</label>
                ...
                <div>
                    <label for="provincia" class="block text-xs font-semibold text-on-surface-variant mb-1">Provincia</label>
                ...
                <div>
                    <label for="distrito" class="block text-xs font-semibold text-on-surface-variant mb-1">Distrito</label>
                ...
                <div>
                    <label for="corregimiento" class="block text-xs font-semibold text-on-surface-variant mb-1">Corregimiento</label>
                ...
                <div class="sm:col-span-2">
                    <label for="direccion_exacta" class="block text-xs font-semibold text-on-surface-variant mb-1">Dirección Exacta</label>
                ...
                <div class="sm:col-span-2">
                    <label for="referencia" class="block text-xs font-semibold text-on-surface-variant mb-1">Referencia (Opcional)</label>
        ...
        <div class="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 shadow-sm mb-8">
            ...
            <select name="zona_envio_id" id="zona_envio_id" required class="block w-full rounded-md border-outline-variant shadow-sm py-3 pl-3 pr-10 text-sm focus:border-secondary focus:outline-none focus:ring-secondary bg-surface-container-lowest">
