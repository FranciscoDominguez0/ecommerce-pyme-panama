...
@section('breadcrumbs')
    ...
    <span class="material-symbols-outlined text-[13px] text-slate-300 shrink-0">chevron_right</span>
    <span class="font-bold text-slate-900 dark:text-white truncate">Registrar Salida</span>
@endsection
...
<div class="max-w-3xl space-y-6">
    ...
    <div class="flex items-center gap-3 pb-4 border-b border-slate-200 dark:border-gray-700/80">
        ...
        <div>
            <h2 class="text-xl sm:text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Registrar Salida de Inventario</h2>
            <p class="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium mt-0.5">Reduce unidades del stock existente.</p>
        </div>
    </div>
            ...
            <div class="bg-slate-50 dark:bg-transparent border border-slate-200 dark:border-gray-700 rounded-xl p-5 mb-6">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div class="flex flex-col items-center sm:items-end text-center sm:text-right">
                        ...
                        <span id="resumen-stock-nuevo" class="text-3xl font-extrabold tabular-nums text-slate-900 dark:text-white">—</span>
                    </div>
                </div>
            </div>
...
(function() {
    ...
    function actualizarResumen() {
        ...
        if (stockActual !== null) {
            ...
            resumenNuevo.className      = 'text-3xl font-extrabold tabular-nums ' + (nuevo < 0 ? 'text-red-600' : 'text-slate-900 dark:text-white');
