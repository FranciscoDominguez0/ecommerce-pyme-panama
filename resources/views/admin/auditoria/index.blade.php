...
<div class="space-y-6 font-sans" x-data="auditoriaModal()">
                    ...
                    <tr class="hover:bg-slate-50 dark:bg-transparent dark:hover:bg-gray-700/30 dark:bg-transparent dark:hover:bg-gray-700/30 dark:bg-transparent dark:hover:bg-gray-700/30 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                @else
                                    <div class="h-8 w-8 rounded-full bg-slate-100 dark:bg-transparent flex items-center justify-center text-slate-400 font-bold text-xs uppercase shrink-0">
                                        S
                                    </div>
                                    <div class="ml-3">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button @click="abrirDetalle({{ $log->id }})" class="text-primary dark:text-blue-400 hover:text-primary dark:text-blue-400/80 bg-primary/10 dark:bg-blue-900/30 hover:bg-primary/20 dark:hover:bg-blue-900/50 p-2 rounded-md transition-colors inline-flex items-center w-[34px] h-[34px] justify-center" title="Ver Detalle">
    ...
    <div x-show="modalOpen" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <div x-show="modalOpen" x-transition.scale.origin.bottom class="relative inline-block w-full max-w-4xl p-6 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-[#181a1b] shadow-2xl rounded-2xl">
                
                <!-- Skeleton Loader -->
                <div x-show="cargando" class="animate-pulse space-y-4">
                    <div class="h-6 bg-slate-200 dark:bg-gray-700 rounded w-1/4 mb-6"></div>
                    <div class="grid grid-cols-2 gap-4"><div class="h-40 bg-slate-100 dark:bg-transparent rounded"></div><div class="h-40 bg-slate-100 dark:bg-transparent rounded"></div></div>
                </div>
                ...
                <div x-show="!cargando && logDetalle">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Valor Anterior -->
                        <div class="border border-red-200 rounded-xl overflow-hidden flex flex-col bg-white dark:bg-[#181a1b]">
                        ...
                        <!-- Valor Nuevo -->
                        <div class="border border-emerald-200 rounded-xl overflow-hidden flex flex-col bg-white dark:bg-[#181a1b]">
