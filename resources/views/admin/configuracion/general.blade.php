...
<div class="space-y-6 font-sans">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Configuración General</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Administra los datos, pagos e impuestos globales de la tienda.</p>
        </div>
    </div>
    ...
    <div class="card-elevated rounded-xl overflow-hidden mb-8">
        <div class="px-6 py-5 border-b border-slate-200 dark:border-gray-700 bg-white dark:bg-[#181a1b]">
            <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Datos de la empresa</h3>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Esta información aparecerá en facturas y comunicaciones</p>
        </div>
        ...
        <form action="{{ route('admin.configuracion.general.guardar') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-8">
                ...
                <div>
                    ...
                    <div class="flex items-start gap-6" x-data="{ 
                        ...
                        <div class="w-32 h-32 rounded-lg border-2 border-dashed border-slate-300 dark:border-gray-700 bg-slate-50 dark:bg-transparent flex items-center justify-center overflow-hidden relative group cursor-pointer hover:border-emerald-500 transition-colors" @click="$refs.logoInput.click()">
            ...
            <!-- Card Footer Actions -->
            <div class="px-6 py-4 border-t border-slate-200 dark:border-gray-700 bg-slate-50 dark:bg-transparent flex flex-col sm:flex-row justify-between items-center gap-4">
                <span class="text-sm text-slate-500 dark:text-slate-400">Mantén esta información actualizada</span>
