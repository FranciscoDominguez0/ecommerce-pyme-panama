                                ...
                                <td class="py-4 px-5 text-right">
                                    <div class="flex items-center justify-end gap-1.5">
                                        ...
                                        <button type="button" 
                                                ...
                                                class="px-2.5 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 dark:text-slate-300 bg-white dark:bg-[#181a1b] border border-slate-200 dark:border-gray-700 rounded-lg hover:bg-slate-50 dark:bg-transparent dark:hover:bg-gray-700/30 hover:border-slate-300 dark:border-gray-700 transition-all shadow-2xs flex items-center gap-1 cursor-pointer"
                                                title="Editar zona">
...
<div id="modal-zona-envio" class="fixed inset-0 z-50 hidden flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs transition-opacity">
    <div class="bg-white dark:bg-[#181a1b] rounded-2xl border border-slate-200 dark:border-gray-700 shadow-2xl max-w-md w-full p-6 space-y-5 transform transition-all">
        ...
        <div class="flex items-center justify-between border-b border-slate-100 dark:border-gray-700 pb-4">
            ...
            <button type="button" onclick="cerrarModalZona()" class="text-slate-400 hover:text-slate-700 dark:text-slate-300 dark:text-slate-300 p-1 rounded-lg hover:bg-slate-100 dark:bg-transparent transition-colors">
        ...
        <form id="form-zona-envio" method="POST" action="{{ route('admin.zonas-envio.store') }}" class="space-y-4">
            ...
            <div>
                <label for="input-zona-nombre" class="block text-xs font-semibold text-slate-700 dark:text-slate-300 dark:text-slate-300 uppercase tracking-wider mb-1">
            ...
            <div>
                <label for="input-zona-costo" class="block text-xs font-semibold text-slate-700 dark:text-slate-300 dark:text-slate-300 uppercase tracking-wider mb-1">
            ...
            <div class="flex items-center justify-end gap-2 pt-3 border-t border-slate-100 dark:border-gray-700">
                <button type="button" 
                        ...
                        class="px-4 py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-300 dark:text-slate-300 bg-white dark:bg-[#181a1b] border border-slate-200 dark:border-gray-700 rounded-xl hover:bg-slate-50 dark:bg-transparent dark:hover:bg-gray-700/30 transition-colors">
                    Cancelar
                </button>
                <button type="submit" 
